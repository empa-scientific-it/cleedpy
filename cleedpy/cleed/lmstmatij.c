...
mat ms_tmat_ij ( mat Gij, mat Llm, mat Tii, int l_max /* arguments */ )
...
/************************************************************************
 ...
 Gij(l1,m1; l2,m2) = -S[ L(l3,m3) * C(l3,m3,l1,m1,l2,m2)]
    ...
    L(l3,m3) = lattice sum (created in ms_lsum_ij)
...
*************************************************************************/
 ...
 {
#ifdef ERROR
   fprintf(STDERR," *** error (ms_tmat_ij): improper input for lattice sum\n");
#endif
...
#ifdef ERROR
   fprintf(STDERR,
           " *** error (ms_tmat_ij): improper input for atomic scattering\n");
#endif
#ifndef EXIT_ON_ERROR
   return(NULL);
#endif
...
#ifdef WARNING
   fprintf(STDWAR,
     " * warning (ms_tmat_ij): C.G. coefficients had to be recalculated\n");
#endif
 }
