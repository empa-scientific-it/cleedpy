...
mat ms_tmat_ii ( mat Tii, mat Llm, mat Tl, int l_max /* arguments */ )
...
#ifdef WARNING
   fprintf(STDWAR,
     "* warning (ms_tmat_ii): C.G. coefficients had to be recalculated\n");
#endif
 }
...
#ifdef CONTROL
 fprintf(STDCTR,"\n(ms_tmat_ii): (1 - T*Gev)^-1: \n");
 fprintf(STDCTR,"\n(ms_tmat_ii): (1 - T*God)^-1: \n");
#endif
