...
int ms_lsum_ij ( mat *p_Llm_p, mat *p_Llm_m, 
...
/************************************************************************
 ...
 Different prefactor from ms_lsum_ii !
...
*/
 ...
 {
#ifdef ERROR
   fprintf(STDERR," *** error (ms_lsum_ij): damping too small: k_i = %.2e\n",
           k_i);
#endif
...
*/
 ...
 if( r_max > WARN_LEVEL)    /* poor convergence */
   fprintf(STDWAR,
     " *** warning (ms_lsum_ij): damping very weak: k_i = %.2e, eps = %.2e\n",
     k_i, epsilon);
#endif
...
#ifdef CONTROL
 fprintf(STDCTR,
   "(ms_lsum_ij): a1  = (%.3f,%.3f) A, a2  =  (%.3f,%.3f) A\n", 
